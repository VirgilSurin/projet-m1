...
\label{sec:etat}
Les premiers travaux sur ce sujet remontent aux années 1970 avec l'algorithme de Bron-Kerbosch, qui demeure l'une des méthodes les plus utilisées. Cet algorithme est basé sur une approche récursive en profondeur (\textit{depth-first search}) et fonctionne sans générer de doublons, ce qui en fait une solution efficace malgré sa complexité exponentielle dans le pire des cas.

Plusieurs variantes et améliorations de l'algorithme de Bron-Kerbosch ont été proposées pour améliorer ses performances, notamment par l'intégration de techniques de pivotage qui réduisent la taille des sous-problèmes à chaque étape de la récursion. C'est d'ailleurs sur ces variantes, en comparaison avec l'algorithme de Bron-Kerbosch, que nous allons nous attarder dans ce rapport.

Cependant, lorsque le nombre de cliques maximales et bien inférieur au pire des cas, d'autres algorithmes peuvent atteindre de meilleurs performances et être préférables. En 1977, Tsukiyama et al. nous montrent qu'il est possible d'énumérer toutes les cliques maximales en temps polynomial par clique générée\cite{doi:10.1137/0206036}.
